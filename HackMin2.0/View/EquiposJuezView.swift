                        ...
                        if vm.equipos.isEmpty {
                            ...
                            LazyVGrid(columns: columns, spacing: geo.size.height * 0.03) {
                                ...
                                ForEach(vm.equipos, id: \.id_equipo) { equipo in
                                    let yaCalificado = equiposCalificados.contains(equipo.id_equipo)

                                    NavigationLink {
                                        if let rubrica = vm.rubrica, !yaCalificado {
                                            RubricaJuezView(
                                                equipo: equipo,
                                                rubrica: rubrica
                                            ) {
                                        ...
                                        ZStack {
                                            RoundedRectangle(cornerRadius: 24)
                                                ...
                                                .overlay(
                                                    RoundedRectangle(cornerRadius: 24)
                                                        .stroke(
                                                            yaCalificado ? Color.green.opacity(0.9) : Color.clear,
                                                            lineWidth: 2
                                                        )
                                                )
                                            ...
                                            // Candado encima si ya fue calificado
                                            if yaCalificado {
                                                VStack {
                                                    HStack {
                                                        Spacer()
                                    ...
                                    .buttonStyle(.plain)
                                    .disabled(yaCalificado)  // ← bloquea el tap completamente
                                }
                            }
